...
namespace Carpool.App.ViewModels
{
    public class RecipeDetailViewModel : ViewModelBase, IRecipeDetailViewModel
    {
        ...
        private RecipeWrapper? _model = UserDetailModel.Empty;
        private IngredientAmountWrapper? _selectedIngredientAmount;

        public RecipeDetailViewModel(
            UserFacade recipeFacade,
        ...
        public async Task LoadAsync(Guid id) => Model = await _recipeFacade.GetAsync(id) ?? UserDetailModel.Empty;
        ...
        public override void LoadInDesignMode()
        {
            ...
            Model = new RecipeWrapper(new UserDetailModel(
                Name: "Spaghetti",
